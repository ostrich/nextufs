...
This document reverse-engineers the existing `fsck.legacy/` tree and treats it as the
...
- `fsck.legacy/main.c`
- `fsck.legacy/setup.c`
- `fsck.legacy/utilities.c`
- `fsck.legacy/pass1.c`
- `fsck.legacy/pass1b.c`
- `fsck.legacy/pass2.c`
- `fsck.legacy/pass3.c`
- `fsck.legacy/pass4.c`
- `fsck.legacy/pass5.c`
...
The current `fsck.legacy/` tree is not identical to the historical checker source.
...
- untracked `fsck.legacy/source.c`
